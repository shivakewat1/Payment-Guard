...
import { 
  ...
  Sparkles, ArrowRight, ChevronRight, Bell, TrendingUp
} from 'lucide-react';
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#E9E9E9] text-[#151515] overflow-x-hidden relative font-sans selection:bg-[#FF6A00] selection:text-white pb-16">
        ...
        <header className="bg-slate-300/40 backdrop-blur-md rounded-2xl border border-white/60 shadow-lg px-4 py-2.5 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1 bg-white/80 p-1 rounded-xl border border-white/80 shadow-inner font-mono text-xs font-bold">
            {[
              ...
              { id: 'revenue', label: '💰 ROI CALCULATOR' },
      ...
      {/* EDITORIAL HERO SECTION - Rendered exclusively on Overview tab */}
      {activeTab === 'overview' && (
          ...
          <div className="lg:col-span-5 relative z-10 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <button
                ...
                className="px-5 py-3.5 rounded-xl bg-[#151515] hover:bg-black text-cyan-400 border border-slate-800 font-mono text-xs font-bold transition-all shadow-md flex items-center gap-2"
              >
                <span>💰 ROI IMPACT (₹20 Cr)</span>
      ...
      <main className="max-w-7xl mx-auto px-4 mt-6 space-y-8 relative z-10">
        ...
        {/* Banner Alert Bar & Metrics - Rendered on Overview */}
        {activeTab === 'overview' && (
          <>
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === 'revenue' && (
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <RevenueImpactDashboard onGetStarted={() => {
          ...
          {activeTab === 'pricing' && (
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <PricingPage onSelectPlan={(planId) => {
                showToast(`Selected ${planId} Tier! Ready for Razorpay Onboarding.`, 'success');
              }} />
            </motion.div>
          )}
          ...
          {activeTab === 'compare' && (
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <CompetitorComparison onGetStarted={() => handleTabChange('overview')} />
            </motion.div>
          )}
